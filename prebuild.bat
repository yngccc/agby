...
if "%~2"=="editor" (
	...
	mkdir hlsl
	del /Q hlsl\*
	forfiles /p ..\..\src\hlsl /m *.vps.hlsl /c "cmd /c dxc.exe /nologo /Od /Zi /T vs_5_1 /E vertex_shader /Fo ..\\..\\build\\"%build_type%"\\hlsl\\@FNAME.vs.bytecode @PATH"
	forfiles /p ..\..\src\hlsl /m *.vps.hlsl /c "cmd /c dxc.exe /nologo /Od /Zi /T ps_5_1 /E pixel_shader /Fo ..\\..\\build\\"%build_type%"\\hlsl\\@FNAME.ps.bytecode @PATH"
