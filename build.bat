...
pushd "%~dp0\src"
	...
	../vendor/include/imgui/imgui.h ../vendor/include/tinygltf/tiny_gltf.h %VULKAN_SDK%/include/vulkan/vulkan.h
popd	
)
...
set compile_editor=start /b cl ..\src\editor.cpp %flags% /MD %dirs% %libs% %bullet3_libs% 
set compile_game=start /b cl ..\src\game.cpp %flags% /MD %dirs% %libs% %bullet3_libs%
set compile_import=start /b cl ..\src\import.cpp %flags% /MD %dirs% %libs% nvtt.lib
set compile_lightmap=start /b cl ..\src\lightmap.cpp %flags% /MD %dirs% %libs% UVAtlas.lib DirectXMesh.lib
set compile_test=start /b cl ..\src\test.cpp %flags% /MD %dirs% %libs%
